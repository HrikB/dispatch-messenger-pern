...
var UserResolver = /** @class */ (function () {
    ...
    UserResolver.prototype.registerUser = function (firstName, lastName, email, password) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, entity_1.User.insert({ firstName: firstName, lastName: lastName, email: email, password: password })];
                    case 1:
                        _a.sent();
    ...
    __decorate([
        (0, type_graphql_1.Query)(function () { return [entity_1.User]; }),
